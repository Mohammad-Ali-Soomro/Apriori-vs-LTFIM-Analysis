...
Results for Accidents Dataset: The Accidents dataset provides a large-scale real-world test case for scalability, featuring over 340,183 transactions and 468 unique items. Experimental trends successfully mirror our earlier smaller-scale observations, yet the absolute time discrepancies widen exponentially. By restricting scanning times, Bitwise strategies completed iterations robustly while horizontal standard algorithms bottlenecked severely across low-support limits—solidifying optimized Bitwise FIM as a necessary component for handling macro-scale itemset data.
